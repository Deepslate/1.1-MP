	...
	public function decodePayload(){
		...
		switch($this->eventType){
			...
			case self::TYPE_SHOW:
				...
				$this->healthPercent = ((\ENDIANNESS === 0 ? \unpack("f", \strrev($this->get(4)))[1] : \unpack("f", $this->get(4))[1]));
			/** @noinspection PhpMissingBreakStatementInspection */
	...
	public function encodePayload(){
		...
		switch($this->eventType){
			...
			case self::TYPE_SHOW:
				...
				($this->buffer .= (\ENDIANNESS === 0 ? \strrev(\pack("f", $this->healthPercent)) : \pack("f", $this->healthPercent)));
			/** @noinspection PhpMissingBreakStatementInspection */
			case self::TYPE_UNKNOWN_6:
